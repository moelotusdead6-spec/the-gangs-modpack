...
execute unless score @s gangs_cycle_start matches -2147483648..2147483647 run function gangs_kits:init_player
...
execute if score #temp gangs_temp matches 2592000.. run function gangs_kits:reset_player_cycle
...
execute if score #temp gangs_temp matches 0.. if score @s gangs_claimed_w1 matches 0 if score @s gangs_perm_w1 matches 0 run function gangs_kits:unlock_w1
...
execute if score #temp gangs_temp matches 1814400.. if score @s gangs_claimed_m matches 0 if score @s gangs_perm_m matches 0 run function gangs_kits:unlock_m
